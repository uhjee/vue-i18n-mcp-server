...
export interface I18nFunctionConfig {
  vue: {
    template: string;  // Vue template에서 사용할 함수
    script: string;    // Vue script에서 사용할 함수
  };
  javascript: {
    function: string;  // JS/TS에서 사용할 함수
  };
}
 ...
 */
export const DEFAULT_I18N_CONFIG: I18nFunctionConfig = {
  vue: {
    template: '$t',      // {{ $t('key') }}
